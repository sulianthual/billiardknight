...
class obj_scenemanager:
    def __init__(self):
        ...
        self.creditscreen=obj_creditscreen(self)# credits
...
class obj_titlescreen:
    def __init__(self,creator):
        ...
        self.rect_credits=(300*scsx,500*scsx,500*scsy,540*scsy)
        self.rect_quit=(300*scsx,500*scsx,550*scsy,590*scsy)
    def draw(self):
        screen.blit(self.img, (0, 0))
        for i,j,k in zip([self.rect_start,self.rect_settings,self.rect_credits,self.rect_quit],\
               [self.hoveringstart,self.hoveringsettings,self.hoveringcredits,self.hoveringquit],\
                ['Start','Settings','Credits','Quit']):# Fullscreen options omitted for now
    ...
    def gotocredits(self,controls):
        if self.hoveringcredits and (controls.mouse1 and controls.mouse1c):
            sound.play('menugo')
            self.creator.changescene('credits',False)
    ...
    def hovers(self,controls):
        ...
        self.hoveringcredits=isinrect(controls.mousex,controls.mousey,self.rect_credits)
...
class obj_creditscreen:
    ...
    def draw(self):
        screen.fill((159,26,26))# red
        i=self.rect_title
        idec=(i[0]-3,i[1]-3,i[2]+2,i[3]+2)
        func_drawtextinrect('Credits',self.bigfont,(255,255,255),idec)
        func_drawtextinrect('Credits',self.bigfont,self.getcolor(False),self.rect_title)
        #
        i=self.rect_return
        idec=(i[0]-3,i[1]-3,i[2]+2,i[3]+2)
        ...
        # Credits:
        # A game by Sulian Thual, 2020 (GNU General Public License v3.0).
        # All musics from PlayOnLoop.com (Licensed under Creative Commons by Attribution 4.0).
        # Sounds from Kenney.nl (License CC0 1.0 Universal),
        # Juhani Junkala (License CC0 creative commons),
        # and opengameart.org (Fupi and Johan Brodd 2014, License Public Domain).
